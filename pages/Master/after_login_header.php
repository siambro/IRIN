...
<head>
  ...
  <script type="text/javascript" src="../dist/js/momnet.js"></script>
  ...
  ?>
    <title>B A | Shopper Dashboard</title>
  <?php
    }
    else if($_SESSION['level'] =="traveller"){
  ?>
    <title>B A | Traveller Dashboard</title>
  <?php
    }
    else if($_SESSION['level'] =="admin"){
  ?>
    <title>B A | Admin Dashboard</title>
  <?php
    }
  ?>
